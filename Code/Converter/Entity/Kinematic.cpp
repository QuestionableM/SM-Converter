...
char* SMKinematic::GetMtlNameCStr(const std::string& v_mat_name, const std::size_t& v_idx, char* v_ptr) const
{
...
bool SMKinematic::GetCanWrite(const std::string& name, const std::size_t& v_idx) const
{
